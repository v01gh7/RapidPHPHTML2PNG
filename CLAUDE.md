...
This command **requires** the project directory as an argument via `D:\_DEV_\SelfProjects\RapidHTML2PNG`.

**Example:** `/create-spec generations/my-app`

**Output location:** `D:\_DEV_\SelfProjects\RapidHTML2PNG/.autoforge/prompts/app_spec.txt` and `D:\_DEV_\SelfProjects\RapidHTML2PNG/.autoforge/prompts/initializer_prompt.md`

If `D:\_DEV_\SelfProjects\RapidHTML2PNG` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `D:\_DEV_\SelfProjects\RapidHTML2PNG/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `D:\_DEV_\SelfProjects\RapidHTML2PNG/.autoforge/prompts/app_spec.txt`
...
**Output path:** `D:\_DEV_\SelfProjects\RapidHTML2PNG/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `D:\_DEV_\SelfProjects\RapidHTML2PNG/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `D:\_DEV_\SelfProjects\RapidHTML2PNG/.autoforge/prompts/`!
>
> **Files created:**
> - `D:\_DEV_\SelfProjects\RapidHTML2PNG/.autoforge/prompts/app_spec.txt`
> - `D:\_DEV_\SelfProjects\RapidHTML2PNG/.autoforge/prompts/initializer_prompt.md`
>
