 ...
 * It's designed to be run with: php test_feature_14_host_v2.php
 */
...
clearCssCache($cssUrl);
if (cacheExists($cssUrl)) {
...
// Get cache file info
$cacheMtime1 = getCacheFileMtime($cssUrl);
$cacheContent1 = getCacheContent($cssUrl);
echo "Cache file mtime: " . date('Y-m-d H:i:s', $cacheMtime1) . "\n";
echo "Cache file size: " . strlen($cacheContent1) . " bytes\n";
echo "Cache file path: " . getCacheFilePath($cssUrl) . "\n";
...
// Get cache file info
$cacheMtime2 = getCacheFileMtime($cssUrl);
...
$cacheContent2 = getCacheContent($cssUrl);
...
$cacheMtime3 = getCacheFileMtime($cssUrl);
